...
const CartPage: React.FC = () => {
  ...
  {/*<img
      src={rowData.imagen}
      alt={rowData.nombre}
      className="w-48 h-48 object-cover rounded-md sm:ml-0 sm:w-40 "
    />*/}
      ...
      <Card className="shadow-lg p-4 bg-white rounded-xl border border-gray-300 col-span-1">{ /*md:w-3/4 lg:w-2/3*/}
        ...
        <div className="totales flex gap-12 mt-12 place-content-end xl:gap-6">
          ...
          <Button
            ...
            className="bg-[#0b4468] w-auto px-3 py-3 text-lg text-white font-semibold transition-all hover:scale-105"
