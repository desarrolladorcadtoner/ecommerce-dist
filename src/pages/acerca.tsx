      ...
      <div className="flex flex-col min-h-screen">
        ...
        <div className="relative h-[550px] sm:h-[400] overflow-hidden">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <h1 className="text-white text-[2.25rem] md:text-[3rem] sm:flex sm:flex-col  sm:text-center sm:mt-24 font-bold z-10 whitespace-nowrap">
              <span className="mr-2 font-light sm:text-[52px]">EL MÁS</span>
              <span className="text-[3.75rem] md:text-7xl sm:text-[72px]">GRANDE</span>
            </h1>
          </div>
        </div>
        ...
        <main className="flex-grow sm:p-8 sm:flex sm:justify-center">
          <div className="container mx-auto px-4 py-12 sm:m-0 sm:p-0 sm:flex sm:flex-col sm:justify-center">
            <section className="text-center max-w-4xl mx-auto">
              <h2 className="text-[1.875rem] font-bold mb-8 text-[#005580]">¿QUIÉNES SOMOS?</h2>
            ...
            <section className="text-center max-w-4xl mx-auto mt-12">
              <h2 className="text-[1.875rem] font-bold mb-8 text-[#005580]">Misión</h2>
            ...
            <section className="text-center max-w-4xl mx-auto mt-12">
              <h2 className="text-[1.875rem] font-bold mb-8 text-[#005580]">Visión</h2>
              <p className="text-gray-700 mb-6">
            ...
            <h2 className="text-[1.875rem] font-bold mb-8 text-[#005580] text-center">Valores</h2>
